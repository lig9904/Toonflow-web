<template>
  <section class="preflightPanel" aria-label="视频生成前检查">
    <div class="header"><strong>视频生成前检查</strong><t-button size="small" variant="outline" :loading="busy" :disabled="busy" @click="$emit('check')">重新检查当前输入</t-button></div>
